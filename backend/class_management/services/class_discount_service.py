...
class ClassDiscountIntegrationService:
    ...
    Class management owns the class order.
    Discounts owns eligibility, calculation, and usage persistence.
    """
    ...
    def preview_class_discount(
        *,
        ...
        """
        Preview discount impact before accepting/applying it.
        """
    ...
    def apply_class_discount(
        *,
        ...
        """
        Apply discount to a class payable after client acceptance.
        """
    ...
    def _build_context(
        *,
        ...
        """
        Build the generic discount payable context.
        """
