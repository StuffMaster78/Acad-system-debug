...
class ClassCommunicationAdapter:
    """
    Adapter exposing class work to communications.
    """

    target_type = "class_order"

    def get_context(self, *, target) -> CommunicationTargetContext:
        """
        Return normalized class communication context.
        """
    ...
    def get_default_participants(
        ...
        *,
        ...
        """
        Return default participants for class communication.
        """
