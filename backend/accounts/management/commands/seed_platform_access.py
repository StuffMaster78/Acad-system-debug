...
class Command(BaseCommand):
    ...
    PERMISSIONS = [
        ...
        ("payments.manage_gateway", "Manage Payment Gateway Config"),
        ...
        ("wallets.view_own", "View Own Wallet"),
        ("payments.view_own", "View Own Payments"),
        ("payments.create_own", "Create Own Payments"),
        ("orders.request_revision", "Request Order Revision"),
        ("orders.open_dispute", "Open Order Dispute"),
        ("special_orders.create_own", "Create Own Special Order"),
        ("special_orders.view_own", "View Own Special Orders"),
        ("class_orders.create_own", "Create Own Class Order"),
        ("class_orders.view_own", "View Own Class Orders"),
        ("disputes.view_own", "View Own Disputes"),
        # Writer-facing permissions
        ("wallets.view_writer_own", "View Own Writer Wallet"),
        ("orders.submit_order", "Submit Completed Order"),
        ("orders.request_hold", "Request Order Hold"),
    ]
    ...
    ROLE_PERMISSION_MAP = {
        ...
        "admin": [
            ...
            "payments.view",
            "payments.manage_gateway",
            "files.view_audit",
            "wallets.view",
            "wallets.adjust",
            "wallets.manage_holds",
            "wallets.reconcile",
            "ledger.view",
            "cms.create_content",
            "cms.edit_content",
        ...
        "client": [
            ...
            "payments.view_own",
            "payments.create_own",
            "special_orders.create_own",
            "special_orders.view_own",
            "class_orders.create_own",
            "class_orders.view_own",
            "disputes.view_own",
        ],
        "editor": [
            "editor.view_tasks",
