...
from mass_emails.analytics import views as analytics_views
from mass_emails.dashboards.campaign import CampaignAnalyticsDashboard
from mass_emails.dashboards.trending import CampaignTrendingAnalytics
from mass_emails.views import AdminEmailHistoryView, UserEmailHistoryView
...
urlpatterns += [
    path(
        ...
        analytics_views.track_open,
        name='email-track-open',
    ),
    path(
        'track/click/<int:recipient_id>/',
        analytics_views.track_click,
        name='email-track-click',
    ),
    path(
        'unsubscribe/<int:recipient_id>/',
        analytics_views.unsubscribe,
        name='email-unsubscribe',
    ),
    path(
        'analytics/campaigns/',
        CampaignAnalyticsDashboard.as_view(),
        name='campaign-analytics',
    ),
    path(
        'analytics/trending/',
        CampaignTrendingAnalytics.as_view(),
        name='campaign-trending',
    ),
    path(
        'email-history/',
        UserEmailHistoryView.as_view(),
        name='email-history',
    ),
    path(
        'email-history/',
        UserEmailHistoryView.as_view(),
        name='user-email-history',
    ),
    path(
        'admin/email-history/',
        AdminEmailHistoryView.as_view(),
