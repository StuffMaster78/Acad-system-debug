...
from order_pricing_core.api.serializers.diagram_order_quote_serializers import (
    DiagramOrderQuoteRequestSerializer,
)
...
class DiagramOrderQuoteStartView(APIView):
    """
    Start a diagram order quote session.
    """

    def post(self, request: Request) -> Response:
        """
        Create an estimate-mode diagram order quote.
        """
        serializer = DiagramOrderQuoteRequestSerializer(data=request.data)
...
class DiagramOrderQuoteUpdateView(APIView):
    """
    Update a diagram order quote session.
    """

    def post(self, request: Request, session_id: str) -> Response:
        """
        Recalculate a diagram order quote in final mode.
        """
        serializer = DiagramOrderQuoteRequestSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
