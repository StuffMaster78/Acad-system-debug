...
class SpecialOrderCommunicationAdapter:
    """
    Adapter exposing special orders to communications.
    """

    target_type = "special_order"

    def get_context(self, *, target) -> CommunicationTargetContext:
        """
        Return normalized special order communication context.
        """
        return CommunicationTargetContext(
            ...
            reference=str(getattr(target, "reference", target.pk)),
            metadata={
                "target_type": self.target_type,
                "special_order_id": target.pk,
            },
        )
    ...
    def user_can_access_target(
        ...
        *,
        ...
        """
        Check special order target access.
        """
        ...
        return CommunicationTargetAccessResult(
            False,
            "User cannot access this special order.",
        )
    ...
    def get_default_participants(
        ...
        *,
        ...
        """
        Return default participants for special order communication.
        """
