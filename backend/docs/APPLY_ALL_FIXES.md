...
## ClassBundle Missing Columns

The error shows that `class_management_classbundle.assigned_writer_id` (and other fields) don't exist.

### Option 1: Apply Migration (Recommended)
```bash
docker-compose exec web python manage.py migrate class_management
```
...
```bash
docker-compose exec web python fix_classbundle_all_fields.py
```

**After running any of these, refresh your admin page.**
