...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='failed_logins', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='failedloginattempt',
            name='website',
        ...
        migrations.AddIndex(
            model_name='otp',
            index=models.Index(fields=['user', 'otp_code'], name='authenticat_user_id_f3647a_idx'),
        ),
    ]
