...
from .views import (
    WriterWalletViewSet, WalletTransactionViewSet, WriterPaymentBatchViewSet, 
    PaymentScheduleViewSet, ScheduledWriterPaymentViewSet, PaymentOrderRecordViewSet, 
    WriterPaymentViewSet, AdminPaymentAdjustmentViewSet, PaymentConfirmationViewSet
)
...
router.register("scheduled-payments", ScheduledWriterPaymentViewSet)
