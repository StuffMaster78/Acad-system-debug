...
useSeoMeta({
  ...
  description: 'EssayManiacs connects students with verified academic writing experts since 2019. Learn how we vet our writers and what we stand for.',
})
  ...
  <div>
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p class="mt-5 text-slate-600 leading-relaxed text-lg">
              EssayManiacs was founded on a simple belief: access to expert academic help shouldn't
    ...
    <section class="bg-brand-700 py-20 text-center">
      ...
      <div class="mt-10 flex flex-wrap justify-center gap-4">
        ...
        >
          Place your first order — from $10/page
        </NuxtLink>
        <NuxtLink
          href="/contact"
