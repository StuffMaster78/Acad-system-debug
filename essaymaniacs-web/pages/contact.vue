...
async function submit() {
  ...
  try {
    ...
    err.value = 'Something went wrong — email us directly at support@essaymaniacs.com'
  } finally {
    busy.value = false
  }
}
...
const channels = [
  ...
  },
  {
    ...
    badge: null,
    badgeColor: '',
    link: 'mailto:support@essaymaniacs.com',
  },
]
...
const faqs = [
  ...
  { q: 'How do I check my order status?', a: 'Log in to your dashboard at app.essaymaniacs.com. You\'ll see real-time progress, messages from your writer, and all deliverables.' },
]
</script>
