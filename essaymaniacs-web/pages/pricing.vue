...
useSeoMeta({
  title: 'Pricing — From $10/Page',
  description: 'Transparent academic writing prices. Research papers from $10/page. Rates vary by academic level, deadline, and subject complexity.',
})

useHead({
  link: [{ rel: 'canonical', href: 'https://essaymaniacs.com/pricing' }],
  script: [{
    ...
    <section class="bg-gradient-to-br from-brand-900 to-brand-700 py-20 text-center">
      <div class="section py-0">
        ...
        <p class="mx-auto mt-4 max-w-xl text-lg text-brand-100">
          Prices start at <strong>$10/page</strong> and depend on your academic level and deadline. No hidden fees.
        </p>
      </div>
    </section>
