...
useSeoMeta({
  title: 'Our Expert Writers & Editors — EssayManiacs',
  description: 'Meet the credentialed academics, editors, and subject-matter experts who produce every article on EssayManiacs.',
  ogImageWidth:  1200,
  ogImageHeight: 630,
    ...
    innerHTML: JSON.stringify({
      ...
      itemListElement: authors.map((a, i) => ({
        ...
        item: {
          ...
          description: a.bio,
          url: `https://essaymaniacs.com/authors/${a.slug}`,
        },
      })),
    }),
  }],
    ...
    <section class="border-b border-slate-200 bg-white px-6 py-16">
      <div class="mx-auto max-w-4xl">
        ...
        <p class="mt-4 max-w-2xl text-lg leading-relaxed text-slate-500">
          Every article on EssayManiacs is written by a credentialed human — a specialist with an advanced
