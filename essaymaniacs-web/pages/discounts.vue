...
useSeoMeta({
  title: 'Essay Writing Discounts & Promo Codes | EssayManiacs',
  description: 'Save on expert essay writing. First-order discounts, loyalty rewards, referral credits, and seasonal promos — see current deals and how to earn more at EssayManiacs.',
  ogImageWidth:  1200,
  ogImageHeight: 630,
...
useHead({
  link: [{ rel: 'canonical', href: 'https://essaymaniacs.com/discounts' }],
  script: [{
    ...
    innerHTML: JSON.stringify({
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Does EssayManiacs offer first-order discounts?',
          acceptedAnswer: { '@type': 'Answer', text: 'Yes. New clients receive a first-order discount automatically at checkout — no code needed when you place your first essay order.' },
        },
        {
          '@type': 'Question',
          name: 'How do loyalty rewards work at EssayManiacs?',
          acceptedAnswer: { '@type': 'Answer', text: 'Every completed order earns loyalty points. Points can be redeemed for discount codes, delivered to your account and usable on future orders.' },
        },
        {
          '@type': 'Question',
          name: 'Is there a referral discount?',
          acceptedAnswer: { '@type': 'Answer', text: 'Yes. Refer a friend and both of you receive a discount code when they complete their first order. Share your referral link from your account dashboard.' },
        },
      ],
    }),
  }],
...
const ways = [
  {
    ...
    badge: 'Auto-applied',
    desc: 'New to EssayManiacs? Your first-order discount is applied automatically at checkout — nothing to enter.',
  ...
  },
  {
    ...
    desc: 'Every completed essay earns you loyalty points. Redeem them for discount codes through your account dashboard.',
    cta: 'View my rewards',
    href: '/login',
  },
  {
    ...
    desc: "Share your unique referral link. When your friend completes their first order, you both receive a discount code.",
  ...
  },
  {
    ...
    desc: 'Holiday and exam-season deals run throughout the year. Check back here or follow us on social for active codes.',
    cta: 'Browse services',
    href: '/services',
  },
  {
...
const faqs = [
  ...
  { q: 'What if my promo code is not working?', a: 'Make sure the code is entered in capitals with no extra spaces. Check whether it has expired or been used already. If the issue persists, contact support.' },
]

const redeemSteps = [
  { n: 1, title: 'Start your order', text: 'Go to the order page and configure your essay — academic level, deadline, and subject.' },
...
<template>
  <div>
    ...
    <!-- Hero -->
    <section class="bg-gradient-to-br from-brand-900 via-brand-800 to-violet-900 px-4 py-20 text-center text-white">
      <div class="mx-auto max-w-3xl">
        <p class="mb-3 text-xs font-bold uppercase tracking-widest text-brand-300">Savings &amp; Promotions</p>
        <h1 class="font-serif text-4xl font-bold leading-tight sm:text-5xl">Essay writing discounts<br>you actually earn</h1>
        <p class="mt-5 text-lg text-brand-100 leading-relaxed">First-order deals, loyalty points, referral credits, and seasonal promos — every way to save on expert academic essays, all in one place.</p>
      ...
      <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div v-for="w in ways" :key="w.title" class="flex flex-col rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <div class="mb-4 flex items-start justify-between gap-3">
            <component :is="w.icon" class="h-8 w-8 text-brand-700" />
    ...
    <section class="bg-brand-800 px-4 py-16 text-center text-white">
      <div class="mx-auto max-w-xl">
        ...
        <p class="mt-3 text-brand-200 text-sm">Professional writers. Grade guarantee. Zero AI.</p>
        <div class="mt-8 flex flex-wrap justify-center gap-3">
