  ...
  <footer class="border-t border-slate-800 bg-slate-900 text-slate-400">
    ...
    <div class="border-b border-slate-800">
      <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-6 px-4 py-5 sm:px-6 lg:px-8">
        <div class="flex items-center gap-2" aria-label="Rated 4.8 out of 5 on Trustpilot">
        ...
        <span class="text-sm"><strong class="text-white">20,000+</strong> essays delivered</span>
        <span class="hidden text-slate-700 sm:block">·</span>
        <span class="text-sm">Grade or money back</span>
        <span class="hidden text-slate-700 sm:block">·</span>
        <span class="text-sm">100% human-written · zero AI</span>
      </div>
    </div>

    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">

      <!-- ── Row 1: Brand · Essays · Advanced · Company ───────────────────── -->
      <div class="grid gap-8 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="space-y-4">
          <span class="flex items-center gap-2">
            <svg width="28" height="28" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <defs>
                <linearGradient id="em-foot" x1="2" y1="2" x2="28" y2="28" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stop-color="#a78bfa"/><stop offset="100%" stop-color="#6d28d9"/>
                </linearGradient>
              </defs>
              <rect x="1" y="1" width="28" height="28" rx="7" fill="url(#em-foot)"/>
            ...
            <span class="text-base font-bold leading-none tracking-tight">
              <span class="text-white">Essay</span><span class="text-brand-300">Maniacs</span>
            </span>
          </span>
          <p class="text-xs leading-relaxed text-slate-500">{{ portal.tagline || 'Essays written by people obsessed with their subject. Not AI, not generalists.' }}</p>
          ...
          <NuxtLink href="/order" class="inline-flex items-center gap-1.5 rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-brand-700">
            Place an order →
          </NuxtLink>
        </div>
        ...
        <!-- Essays & Writing -->
        <div>
          <p class="mb-4 text-[10px] font-bold uppercase tracking-widest text-brand-400">Essays & Writing</p>
          <ul class="space-y-2">
        ...
        <!-- Advanced & More -->
        <div>
          <p class="mb-4 text-[10px] font-bold uppercase tracking-widest text-brand-400">Advanced & More</p>
          <ul class="space-y-2">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid gap-8 border-t border-slate-800 py-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <p class="mb-4 text-[10px] font-bold uppercase tracking-widest text-brand-400">Account</p>
          <ul class="space-y-2">
            ...
            <li><NuxtLink href="/order"   class="text-sm transition-colors hover:text-white">Place an order</NuxtLink></li>
          </ul>
        </div>
        ...
        <div>
          <p class="mb-4 text-[10px] font-bold uppercase tracking-widest text-brand-400">We Guarantee</p>
          <ul class="space-y-1.5 text-sm">
            <li class="flex items-center gap-2"><span class="text-amber-400">★</span> Grade or money back</li>
            <li class="flex items-center gap-2"><span class="text-brand-400">✓</span> Subject-matched writer</li>
