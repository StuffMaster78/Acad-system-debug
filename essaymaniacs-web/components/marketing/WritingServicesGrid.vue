...
const serviceLinks = [
  { label: 'Essay Writing Service',               href: '/services/essays' },
  { label: 'Argumentative Essay Help',            href: '/services/argumentative-essays' },
  { label: 'Research Paper Writing',              href: '/services/research-papers' },
  { label: 'Dissertation Writing Help',           href: '/services/dissertations' },
  { label: 'Thesis Writing Service',              href: '/services/dissertations' },
  { label: 'Term Paper Writing Help',             href: '/services/term-papers' },
  { label: 'Case Study Writing Help',             href: '/services/case-studies' },
  { label: 'Literature Review Writing',           href: '/services/literature-reviews' },
  { label: 'Annotated Bibliography',              href: '/services/annotated-bibliographies' },
  { label: 'Coursework & Assignment Help',        href: '/services/coursework' },
  { label: 'College Admission Essay',             href: '/services/admission-essays' },
  { label: 'Scholarship Essay Writing',           href: '/services/scholarship-essays' },
  { label: 'Personal Statement Writing',          href: '/services/personal-statements' },
  { label: 'Reflective Essay Service',            href: '/services/reflective-essays' },
  { label: 'Book Report & Review',                href: '/services/book-reports' },
  { label: 'Lab Report Writing Service',          href: '/services/lab-reports' },
  { label: 'Data Analysis & Statistics',          href: '/services/data-analysis' },
  { label: 'Presentation Writing Help',           href: '/services/presentations' },
  { label: 'Proofreading & Editing',              href: '/services/proofreading' },
  { label: 'Creative Writing Service',            href: '/services/creative-writing' },
  { label: 'Business Report Writing',             href: '/services/business-reports' },
  { label: 'Compare & Contrast Essay',            href: '/services/argumentative-essays' },
  { label: 'Narrative Essay Writing',             href: '/services/essays' },
  { label: 'Analytical Essay Service',            href: '/services/essays' },
]
</script>
        ...
        <div class="flex h-full flex-col justify-between rounded-2xl bg-brand-900 p-8 text-white">
          <div>
            ...
            <p class="mt-3 leading-relaxed text-brand-200">
              Tell us what you need. We'll match you with a writer who actually cares about your subject. Fast, confidential, grade-guaranteed.
            </p>
            <ul class="mt-6 space-y-2.5 text-sm text-brand-200">
              <li class="flex items-center gap-2.5">
                <Icon name="check-circle" class="h-4 w-4 shrink-0 text-green-400" />
                Writers matched by subject, not just assigned randomly
              </li>
              <li class="flex items-center gap-2.5">
                <Icon name="check-circle" class="h-4 w-4 shrink-0 text-green-400" />
