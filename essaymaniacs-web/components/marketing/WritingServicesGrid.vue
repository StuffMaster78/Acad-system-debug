...
const serviceLinks = [
  { label: 'Essay Writing Service',               href: '/essays' },
  { label: 'Argumentative Essay Help',            href: '/argumentative-essays' },
  { label: 'Research Paper Writing',              href: '/research-papers' },
  { label: 'Dissertation Writing Help',           href: '/dissertations' },
  { label: 'Thesis Writing Service',              href: '/dissertations' },
  { label: 'Term Paper Writing Help',             href: '/term-papers' },
  { label: 'Case Study Writing Help',             href: '/case-studies' },
  { label: 'Literature Review Writing',           href: '/literature-reviews' },
  { label: 'Annotated Bibliography',              href: '/annotated-bibliographies' },
  { label: 'Coursework & Assignment Help',        href: '/coursework' },
  { label: 'College Admission Essay',             href: '/admission-essays' },
  { label: 'Scholarship Essay Writing',           href: '/scholarship-essays' },
  { label: 'Personal Statement Writing',          href: '/personal-statements' },
  { label: 'Reflective Essay Service',            href: '/reflective-essays' },
  { label: 'Book Report & Review',                href: '/book-reports' },
  ...
  { label: 'Proofreading & Editing',              href: '/proofreading' },
  { label: 'Creative Writing Service',            href: '/creative-writing' },
  { label: 'Business Report Writing',             href: '/business-reports' },
  { label: 'Compare & Contrast Essay',            href: '/argumentative-essays' },
  { label: 'Narrative Essay Writing',             href: '/essays' },
  { label: 'Analytical Essay Service',            href: '/essays' },
]
</script>
