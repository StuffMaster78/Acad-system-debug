...
<template>
  <div class="border-t border-white/10 py-14">
    <div class="mx-auto max-w-lg px-4 text-center">

      <!-- Icon -->
      <div class="mx-auto mb-4 flex size-11 items-center justify-center rounded-full bg-gc-500/20">
        <svg class="size-5 text-gc-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"/>
        </svg>
      </div>

      <h2 class="text-xl font-bold text-white sm:text-2xl">Weekly academic writing tips</h2>
      <p class="mt-1.5 text-sm text-slate-400">Expert guides, citation tips, and exclusive discounts — every week.</p>
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
          <input
            ...
            :class="showInvalid
              ...
              : 'border-white/10 bg-white/5 focus:border-gc-400 focus:ring-gc-400/20'"
            @blur="touched = true"
            @input="touched = false"
          />
          <button
            type="submit"
            :disabled="busy"
            class="shrink-0 rounded-xl bg-gc-600 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-gc-500 disabled:opacity-60"
