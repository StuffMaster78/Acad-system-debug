      ...
      <div class="rounded-2xl border border-slate-200 overflow-hidden">
        <div class="flex items-center justify-between gap-3 border-b border-slate-100 bg-slate-50 px-5 py-3">
          ...
          <div class="flex gap-2">
            <span class="rounded-full bg-gc-100 px-2.5 py-0.5 text-[10px] font-bold text-gc-700">
      ...
      <ol class="space-y-3">
        ...
        >
          ...
          <span>
            ...
            <a :href="asStr(asObj(src).url)" target="_blank" rel="noopener noreferrer" class="underline decoration-dotted hover:text-gc-600">
