...
const serviceLinks = [
  { label: 'Capstone Project Writing Help',       href: '/services/capstone-projects' },
  { label: 'Online Nursing Essay Writing Help',   href: '/services/nursing-essays' },
  { label: 'Online Nursing Papers Help',          href: '/services/buy-nursing-papers' },
  { label: 'SOAP Medical Note Writer',            href: '/services/soap-notes' },
  { label: 'Shadow Health Help & Answers',        href: '/services/shadow-health' },
  { label: 'Nursing Classes Help',                href: '/services/online-nursing-classes' },
  { label: 'BSN Writing Services',                href: '/services/bsn-writing' },
  { label: 'Nursing Research Paper Writing',      href: '/services/nursing-research-papers' },
  { label: 'Nursing Report Writing Services',     href: '/services/nursing-report' },
  { label: 'Buy a Nursing Presentation (PPT)',    href: '/services/nursing-presentation' },
  { label: 'Nursing Thesis Writing Service',      href: '/services/nursing-dissertations' },
  { label: 'MSN Writing Help',                    href: '/services/msn-help' },
  { label: 'APA Nursing Papers',                  href: '/services/apa-nursing-papers' },
  { label: 'Write My Concept Map',                href: '/services/concept-maps' },
  { label: 'Nursing Assignments Help',            href: '/services/nursing-coursework' },
  { label: 'Medical Paper Writing Services',      href: '/services/medical-paper-writing' },
  { label: 'Buy Nursing Papers for Sale',         href: '/services/nursing-homework' },
  { label: 'Nursing Coursework Help Online',      href: '/services/nursing-coursework' },
  { label: 'Nursing Care Plan Writing',           href: '/services/care-plans' },
  { label: 'Nursing Homework Help Online',        href: '/services/nursing-homework' },
  { label: 'Nursing Dissertation Help Online',    href: '/services/nursing-dissertations' },
  { label: 'Do My Nursing Case Study',            href: '/services/nursing-case-studies' },
  { label: 'Health & Medical Writers',            href: '/services/health-medical-writers' },
