...
const ldScripts = computed(() => {
  ...
  scripts.push({
    ...
    innerHTML: JSON.stringify({
      ...
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.post-excerpt', '.key-takeaways', 'h1'] },
    }),
  })
  scripts.push({
    type: 'application/ld+json',
  ...
  <div class="section">
    ...
    <div class="grid gap-10 lg:grid-cols-[1fr_300px]">
      ...
      <article class="min-w-0">
        ...
        <p class="post-excerpt mt-4 text-lg leading-relaxed text-slate-600">{{ postExcerpt }}</p>
        ...
        <!-- TOC -->
        <ArticleToc v-if="allTocItems.length >= 3" :items="allTocItems" variant="progress" />
