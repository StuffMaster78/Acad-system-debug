...
const orderPaths = [
  ...
  { id: 'class',   label: 'Online Class Help',     desc: 'Full course or individual module management',      href: '/online-nursing-classes', color: 'text-green-600'  },
  { id: 'special', label: 'Capstone / Dissertation', desc: 'End-to-end BSN, MSN, or DNP project support', href: '/capstone-projects', color: 'text-rose-600'   },
  { id: 'combo',   label: 'Mentoring',             desc: 'Admission essays, career guidance, school prep',  href: '/contact',            color: 'text-amber-600'  },
  { id: 'diagram', label: 'Concept Maps',          desc: 'Pathophysiology linkage maps for any scenario',   href: '/concept-maps', color: 'text-teal-600'   },
            ...
            <div class="grid grid-cols-4 gap-5">
              ...
              <div class="col-span-2 flex flex-col gap-3">
                ...
                <div class="rounded-xl bg-brand-900 p-3 text-center">
                  <p class="text-xs font-semibold text-white">Start from $24/page</p>
                  <p class="mt-0.5 text-xs text-brand-300">4.98★ · 9,800+ nursing orders</p>
