...
const AUTHORS: Record<string, BlogAuthor> = {
  sarah: {
    ...
    role: 'Senior Writer',
    bio: 'Dr. Kimani is a Doctor of Nursing Practice and Family Nurse Practitioner with over twelve years of clinical and academic experience. She has taught advanced practice nursing at graduate level and has guided hundreds of BSN, MSN, and DNP students through capstone projects, clinical papers, and evidence-based practice writing. Her expertise spans APA 7th edition, PICOT development, and nursing research methodology.',
  ...
  james: {
    ...
    role: 'Senior Writer',
    bio: 'James is a board-certified registered nurse with a Master of Science in Nursing and eight years of clinical experience in medical-surgical and critical care settings. He has been writing nursing academic content for six years, specialising in care plans, SOAP notes, case studies, and reflective practice journals. James writes the way nurses think — clinically grounded and evidence-based.',
    linkedin: 'https://linkedin.com',
    twitter: 'JWhitfieldMSN',
  },
  emily: {
    name: 'Dr. Emily Chen',
    slug: 'emily-chen',
    ...
    bio: 'Dr. Chen holds a PhD in Nursing Science and an MSN with a focus on nursing education and qualitative research. She spent a decade as a nursing faculty member supervising thesis and capstone students before transitioning to academic writing. Her speciality is nursing research methodology, systematic literature reviews, and evidence appraisal using frameworks like the Iowa Model and ACE Star.',
  ...
  michael: {
    ...
    credentials: 'BSN, RN',
    role: 'Writer',
    bio: 'Michael is a registered nurse with a BSN and five years of clinical experience in community health and psychiatric nursing. He has been writing nursing study guides, care plan templates, and clinical documentation resources for four years. Michael has a talent for breaking down complex nursing frameworks — NANDA, NIC, NOC, ADPIE — into clear, actionable writing that nursing students can actually use.',
    linkedin: 'https://linkedin.com',
    twitter: 'MTorresBSN',
  },
}
