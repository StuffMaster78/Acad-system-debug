...
const FALLBACK: PortalContext = {
  surface: 'client',
  portal: null,
  website: { id: 0, name: 'NurseMyGrade', slug: 'nursemygrade', domain: 'nursemygrade.com' },
  branding: {
    brand_name: 'NurseMyGrade',
    tagline: 'Nursing papers written by real BSN, MSN & DNP nurses — from $24/page.',
    logo_url: '',
    favicon_url: '',
    ...
    homepage_subheadline: 'BSN, MSN & DNP nurses write your care plans, SOAP notes, capstone projects, and essays — from $24/page. Grade or money back.',
    social_twitter_url: '',
    social_facebook_url: '',
...
export const usePortalStore = defineStore('portal', {
  ...
  getters: {
    brandName:    (s) => s.ctx.branding?.brand_name    ?? s.ctx.website?.name ?? 'NurseMyGrade',
