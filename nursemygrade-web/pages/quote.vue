    ...
    <div class="bg-gradient-to-br from-brand-900 to-brand-700 py-12 text-center">
      <div class="section py-0">
        <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10">
          <Icon name="sparkles" class="h-7 w-7 text-white" />
        </div>
        ...
        <div class="mt-4 flex flex-wrap justify-center gap-4 text-sm text-brand-200">
          <span class="flex items-center gap-1.5"><Icon name="message-square" class="h-4 w-4" /> Quote within 2 hours</span>
          <span class="flex items-center gap-1.5"><Icon name="dollar-sign" class="h-4 w-4" /> No obligation</span>
          <span class="flex items-center gap-1.5"><Icon name="clock" class="h-4 w-4" /> 24/7 response</span>
        </div>
      </div>
    </div>
