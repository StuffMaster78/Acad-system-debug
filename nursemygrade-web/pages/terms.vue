...
<template>
  <div class="section max-w-3xl">
    ...
    <div class="prose prose-slate mt-10 max-w-none">
      ...
      <h2>3. Revisions and refunds</h2>
      <p>Free revisions are available within the revision window specified at order placement. Refunds are assessed on a case-by-case basis in line with our grade or money-back guarantee.</p>

      <h2>4. Intellectual property</h2>
      <p>Upon payment, you receive full rights to use the delivered content. Our writers retain no claims over work delivered to you.</p>

      <h2>5. Limitation of liability</h2>
      <p>Our liability is limited to the value of the order placed. We are not responsible for academic consequences arising from misuse of our materials.</p>
