...
from admin_management.managers import AdminManager  # Import the centralized manager
...
class AdminProfile(models.Model):
    ...
    """
    user = models.OneToOneField(User, on_delete=models.CASCADE, unique=True, related_name="admin_profile")
    ...
    last_action = models.CharField(max_length=255, blank=True, null=True, help_text="Last performed action.")
...
class AdminLog(models.Model):
    ...
    old_data = models.JSONField(null=True, blank=True, help_text="Previous data before change.")
...
class BlacklistedUser(models.Model):
    ...
    reason = models.TextField(blank=True, null=True, help_text="Reason for blacklisting.")
