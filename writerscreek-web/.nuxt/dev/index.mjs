...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, appendResponseHeader, getRequestProtocol, getRequestHost, setHeader, getQuery as getQuery$1, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unhead@2.1.15/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/vue@3.5.38_typescript@5.9.3/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unhead@2.1.15/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/vue@3.5.38_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.11.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.11.1/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/youch@4.1.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/devalue@5.8.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import devalue from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/@nuxt+devalue@2.0.2/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createFilter } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/nuxtseo-shared@5.3.0_1a18cfffdf88c684e52cf7a89b0a810c/node_modules/nuxtseo-shared/dist/utils.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/unhead@2.1.15/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/awwy/writing_project/writerscreek-web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/awwy/writing_project/writerscreek-web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/awwy/writing_project/writerscreek-web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/awwy/writing_project/writerscreek-web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/awwy/writing_project/writerscreek-web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/awwy/writing_project/writerscreek-web/.data/kv"}));
...
const _gukMbEPYfMnVLjgGxgPxQ1XvBwxUvpR47w4HcV1RG5M = (nitroApp) => {
...
const _hC7hs_3bYiQrLDaectqHUdf_BrUn8CUTx4MwkWHfSTg = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _mI1TeolG1riqzx84kPFiBbKBs2hUSDPVhZV5azmZJA,
_gukMbEPYfMnVLjgGxgPxQ1XvBwxUvpR47w4HcV1RG5M,
_hC7hs_3bYiQrLDaectqHUdf_BrUn8CUTx4MwkWHfSTg
];
...
const _BynaAy = eventHandler((event) => {
...
const _Q1sAh2 = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _gFsX7D = eventHandler(async (e) => {
...
async function parseSitemapIndex(xml) {
  ...
  const { XMLParser } = await import('file:///Users/awwy/writing_project/writerscreek-web/node_modules/.pnpm/fast-xml-parser@5.9.0/node_modules/fast-xml-parser/src/fxp.js');
...
const _lrk5fu = defineEventHandler(async (e) => {
...
const _bPdzAZ = defineEventHandler(async (e) => {
...
const _12klr4 = defineEventHandler(async (e) => {
...
const _lmR7VU = defineEventHandler(sitemapXmlEventHandler);

const _lazy_3uzKZC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _BynaAy, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_3uzKZC, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Q1sAh2, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _gFsX7D, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _lrk5fu, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug-production.json', handler: _bPdzAZ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _12klr4, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lmR7VU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3uzKZC, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/awwy/writing_project/writerscreek-web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/awwy/writing_project/writerscreek-web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
