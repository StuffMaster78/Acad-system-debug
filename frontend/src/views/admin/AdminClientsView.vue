    ...
    <section class="grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_minmax(360px,0.8fr)]">
      <div class="rounded-xl border border-slate-200 bg-white">
        <div class="flex items-center gap-2 border-b border-slate-200 px-5 py-4">
          ...
          <div>
            <h2 class="text-base font-semibold text-ink">Clients across websites</h2>
            <p class="text-xs text-graphite">Search by name, email, website, country, or loyalty tier.</p>
          </div>
        </div>
        <div class="flex flex-wrap items-center gap-3 border-b border-slate-100 bg-slate-50 px-5 py-3">
          <div class="flex flex-wrap gap-1">
            <button
              ...
              :class="clients.statusFilter === option.key ? 'bg-ink text-white shadow-sm' : 'bg-white border border-slate-200 text-graphite hover:border-slate-300 hover:text-ink'"
              type="button"
