              ...
              <tr v-for="log in adminLogs" :key="log.id" class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-4 py-3 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-8 w-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold text-xs mr-2">
