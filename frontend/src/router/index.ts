...
function roleRoute(role: UserRole): RouteRecordRaw {
  ...
  if (role === "admin") {
    roleChildren.splice(
      ...
      {
        path: "file-audit",
        name: "admin-file-audit",
        component: () => import("@/views/admin/AdminFileAuditView.vue"),
      },
      {
        path: "writers",
        name: "admin-writers",
      ...
      },
      {
        path: "profit",
        name: "admin-profit",
        component: () => import("@/views/admin/AdminProfitView.vue"),
      },
      {
        path: "discounts",
      ...
      },
      {
        ...
        component: () => import("@/views/admin/AdminPaymentGatewayView.vue"),
      },
      {
        path: "bids",
        name: "admin-bids",
      ...
      },
      {
        ...
        name: "admin-writer-resources",
        component: () => import("@/views/admin/AdminWriterResourcesView.vue"),
      },
      {
        path: "newsletters",
  ...
  if (role === "superadmin") {
    ...
    roleChildren.splice(
      ...
      {
        path: "payment-gateway",
        name: "superadmin-payment-gateway",
        component: () => import("@/views/admin/AdminPaymentGatewayView.vue"),
      },
      {
        path: "special-orders/:id",
      ...
      {
        path: "writer-resources",
        name: "superadmin-writer-resources",
        component: () => import("@/views/admin/AdminWriterResourcesView.vue"),
      },
      {
        path: "clients",
