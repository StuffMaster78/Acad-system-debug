    ...
    try {
      if (auth.isPreviewSession) {
        ...
        crossTenant.value = {
          ...
          top_performers: {
            by_revenue: seededTenants.slice(0, 3),
            by_orders: seededTenants.slice(0, 3),
          },
        };
        dashboard.value = {
          total_users: 3940,
          ...
          system_health: {
            orders_last_24h: 84,
            orders_last_7d: 622,
            new_users_last_24h: 28,
            new_users_last_7d: 293,
            overdue_orders: 9,
          ...
          recent_orders: [
            ...
            { id: 10023, topic: "Comparative literature review", website: "GradeCrest", status: "completed", total_price: 165 },
            { id: 10034, topic: "Research methodology chapter", website: "ResearchPaperMate", status: "in_progress", total_price: 210 },
          ],
        };
        users.value = [
