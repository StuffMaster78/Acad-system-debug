...
export const navigationByRole: Record<UserRole, NavItem[]> = {
  superadmin: [
    ...
    { label: "File Audit", to: "/superadmin/file-audit", icon: Shield },
  ...
  admin: [
    ...
    { label: "File Audit", to: "/admin/file-audit", icon: Shield },
  ...
  client: [
    ...
    { label: "Billing & Wallet", to: "/client/money", icon: CreditCard },
    { label: "Loyalty & Rewards", to: "/client/loyalty", icon: Star },
