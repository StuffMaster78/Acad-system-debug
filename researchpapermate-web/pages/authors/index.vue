  ...
  <div class="min-h-screen bg-slate-50">
    ...
    <section class="border-b border-slate-200 bg-white px-6 py-16">
      <div class="mx-auto max-w-4xl">
        <p class="mb-2 text-xs font-semibold uppercase tracking-wider text-claret-800">Our editorial team</p>
    ...
    <div class="mx-auto max-w-5xl px-6 py-12">
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
        <NuxtLink
          ...
          class="group flex gap-5 rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:border-parchment-300 hover:shadow-md"
        >
          <!-- Avatar -->
          <div
            class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-parchment-200 text-xl font-bold text-claret-800 ring-2 ring-white shadow-sm"
          >
          ...
          <div class="min-w-0">
            <div class="flex flex-wrap items-center gap-2">
              <p class="font-bold text-slate-900 transition-colors group-hover:text-claret-800">
                {{ author.name }}
              </p>
              <span
