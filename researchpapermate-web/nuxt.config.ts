  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preload', as: 'style', href: 'https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&display=swap' },
        {
          rel: 'stylesheet',
