...
const serviceLinks = [
  { label: 'Research Paper Writing Help',      href: '/services/research-papers' },
  { label: 'Custom Essay Writing Service',     href: '/services/essays' },
  ...
  { label: 'Argumentative Essay Help',         href: '/services/essays' },
  { label: 'Analytical Essay Writing',         href: '/services/essays' },
  { label: 'Reflective Essay Service',         href: '/services/essays' },
  { label: 'Term Paper Writing Help',          href: '/services/research-papers' },
  { label: 'Capstone Project Help',            href: '/services/dissertations' },
  { label: 'Annotated Bibliography Help',      href: '/services/literature-reviews' },
  { label: 'Scholarship Essay Writing',        href: '/services/essays' },
  { label: 'Business Case Study Help',         href: '/services/case-studies' },
  { label: 'SPSS & R Data Analysis',           href: '/services/data-analysis' },
  { label: 'Systematic Literature Review',     href: '/services/literature-reviews' },
  { label: 'PowerPoint Presentation Help',     href: '/services/presentations' },
  { label: 'Compare & Contrast Essay',         href: '/services/essays' },
  { label: 'Science Lab Report Help',          href: '/services/lab-reports' },
  { label: 'Nursing Essay Writing',            href: '/services/essays' },
]
</script>
